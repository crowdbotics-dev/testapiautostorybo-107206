...
## Project Structure
    ...
    ├── testapiautostorybo_107206  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_107206`
...
2. Clone this repo and `cd testapiautostorybo_107206`
